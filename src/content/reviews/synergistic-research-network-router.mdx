...
| **Wi-Fi分離** | 本体から機能排除、別途AP接続を推奨 [1](#ref-1) | 光接続された別筐体APで実現 [22](#ref-22) | コントロール用として帯域を割り切った内蔵の超低ノイズWIFI |
