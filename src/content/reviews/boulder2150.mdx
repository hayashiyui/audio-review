...
description: "Boulder 2150 Mono Power Amplifierの包括的レビュー：妥協なきエンジニアリングが生み出す絶対的中立性"
...
| :---- | :---- | :---- | :---- | :---- |
| *Stereophile* (M. Fremer) | 「全体的なサウンドは、音色はニュートラルで完全に透明でありながら、ややドライだと感じた。」 "I felt the Boulders' overall sound, while tonally neutral and utterly transparent, was somewhat dry." [1](#ref-1) | ★★★★☆ | [Link](https://www.stereophile.com/content/boulder-amplifiers-2150-monoblock-power-amplifier-page-2) | 非常に信頼性が高い。Fremer氏は経験豊富な評論家であり、「ドライ」という批判は単なる否定ではなく、具体的かつ繊細なニュアンスを持つ。これは重要な批評であり、偏見に基づくものではない。 |
| *The Absolute Sound* (A. Cordesman) | 「これはこれまでに作られた中で最も色付けが少なく、最高の性能を持つアンプの一つだ。」 "this one of the least-colored, best-performing amplifiers ever made." [15](#ref-15) | ★★★★★ | [Link](https://www.theabsolutesound.com/articles/boulder-2150-mono-power-amplifier-and-2110-preamplifier/) | 極めて肯定的。Cordesman氏はその中立性を絶対的な善と捉え、システムの他の部分の欠点を露わにすると評価する。これは一つの哲学的な立場だが、有効な分析である。メーカー貸与品と思われるが、分析は深く、Boulderの設計目標と一致している。 |
| AudioShark Forum (user "bonzo") | 「Boulderはよりクリーンで速いが、適切にマッチングされないと無機質に聞こえることがある。」 "Boulder is cleaner, faster, and can sound sterile if not matched properly." [16](#ref-16) | ★★★★☆ | [Link](https://www.audioshark.org/threads/boulder-2150-stereophile-review.11264/) | 経験豊富なユーザーの視点。システムの相性の重要性を理解しており、長所（クリーン、高速）と潜在的な短所（無機質）の両方を認識している。メーカーの影響を受けない、価値ある実世界のフィードバックと言える。 |
| YouTube (Jay's Audio Lab) | 「私がこれまでの人生で所有した中でナンバーワンのアンプです。」 "the number one amplifier that I have ever owned in my entire life." [17](#ref-17) | ★★★★★ (98/100) | [Link](https://www.youtube.com/watch?v=lhKf-g-Vs_A) | 熱心なオーナーによるレビュー。確証バイアスの可能性はあるが、その情熱はより分析的な批評に対する有効なカウンターポイントとなる。彼のシステム（Magico M6スピーカー）におけるパフォーマンスに基づいた高い評価である。 |
...
* **出力インピーダンスと周波数特性:** 測定された出力インピーダンスは、スピーカーケーブルを含めても、可聴帯域全体でわずか0.02〜0.026Ωという驚異的な低さであった [14](#ref-14)。これは公称値「0Ω」に極めて近い。この結果、スピーカーのインピーダンス変動による周波数特性の変化は「事実上存在しない」レベルにまで抑え込まれている 14。これは、アンプがスピーカーの気まぐれな挙動に一切影響されず、ただひたすらに信号を送り込むという、絶対的な支配力の証明に他ならない。  
...
* **ノイズフロア:** A補正されたS/N比は97dBという卓越した値を記録した [14](#ref-14)。さらに重要なのはノイズの「質」である。スペクトル分析によれば、電源に由来するハム成分は-110dB（0.0003%）以下であり、これは人間の聴覚の限界を遥かに超えた静寂である 14。この測定不可能なほどの静けさこそが、リスニングインプレッションで語られる「漆黒の背景」の客観的な根拠なのである。  
...
| 評論家 / メディア | 引用抜粋 (和訳＋原文) | 出典URL |
| :---- | :---- | :---- |
| Michael Fremer / *Stereophile* | 「音のアタックとディケイは正確だが、その間のサステインは十分に表現されていなかった。」 "It reproduced precise attacks and ear-popping decays, but the sustains of notes between those attacks and decays were less than fully expressed." [1](#ref-1) | [Link](https://www.stereophile.com/content/boulder-amplifiers-2150-monoblock-power-amplifier-page-2) |
| Anthony Cordesman / *TAS* | 「Boulder 2150は信じられないほどの予備電力と極めて高いダンピングファクターを持っている。」 "the Boulder 2150 has an almost incredible amount of reserve power and an extremely high damping factor." [15](#ref-15) | [Link](https://www.theabsolutesound.com/articles/boulder-2150-mono-power-amplifier-and-2110-preamplifier/) |
| HIFICLUB / YouTube | 「トランジスタアンプでは珍しいシルキーでリキッドな音質も体験できました。」 "we were able to experience... the silky, liquid sound quality that is rare in a transistor amp." [30](#ref-30) | [Link](https://www.youtube.com/watch?v=yM2UD2kzj9U) |
